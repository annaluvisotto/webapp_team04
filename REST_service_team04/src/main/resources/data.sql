...
WITH Composizione_Allenamenti (nome_allenamento, nome_es, serie, rip) AS ( SELECT * FROM (VALUES
...
('Strength', 'Squat', 4, 5), ('Strength', 'Stacchi da terra', 3, 9),
('Strength', 'Affondi', 4, 5), ('Strength', 'Bicipiti ai cavi', 3, 9),
('Strength', 'Lat machine', 4, 5), ('Strength', 'Tricipiti ai cavi', 3, 9)
) AS t(nome_allenamento, nome_es, serie, rip))
